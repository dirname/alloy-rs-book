...
- 运行: `cargo run --example fork_anvil`

```rust,ignore
{{#include ../../../lib/examples/examples/anvil/examples/fork_anvil.rs}}
```

在 Github 上查看源代码[这里](https://github.com/alloy-rs/examples/tree/6ac6ececdbfb33142c128f21df07cd0e92a96620/examples/anvil/examples/fork_anvil.rs)。