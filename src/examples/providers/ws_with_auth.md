...
- 运行：`cargo run --example ws_with_auth`

```rust,ignore
{{#include ../../../lib/examples/examples/providers/examples/ws_with_auth.rs}}
```

可以在 Github 上找到源码 [here](https://github.com/alloy-rs/examples/tree/6ac6ececdbfb33142c128f21df07cd0e92a96620/examples/providers/examples/ws_with_auth.rs)。