...
- 运行: `cargo run --example user_defined_types`

```rust,ignore
{{#include ../../../lib/examples/examples/sol-macro/examples/user_defined_types.rs}}
```

在 Github 上找到源码 [here](https://github.com/alloy-rs/examples/tree/6ac6ececdbfb33142c128f21df07cd0e92a96620/examples/sol-macro/examples/user_defined_types.rs)。