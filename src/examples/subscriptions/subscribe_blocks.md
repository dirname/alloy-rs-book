...
- 运行：`cargo run --example subscribe_blocks`

```rust,ignore
{{#include ../../../lib/examples/examples/subscriptions/examples/subscribe_blocks.rs}}
```

你可以在 Github 上找到源码 [here](https://github.com/alloy-rs/examples/tree/6ac6ececdbfb33142c128f21df07cd0e92a96620/examples/subscriptions/examples/subscribe_blocks.rs)。