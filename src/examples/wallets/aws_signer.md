...
- 运行：`cargo run --example aws_signer`

```rust,ignore
{{#include ../../../lib/examples/examples/wallets/examples/aws_signer.rs}}
```

在 Github 上可以找到源代码 [这里](https://github.com/alloy-rs/examples/tree/6ac6ececdbfb33142c128f21df07cd0e92a96620/examples/wallets/examples/aws_signer.rs)。