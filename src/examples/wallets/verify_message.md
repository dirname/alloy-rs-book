...
- 运行: `cargo run --example verify_message`

```rust,ignore
{{#include ../../../lib/examples/examples/wallets/examples/verify_message.rs}}
```

在 Github 上可以找到源码 [here](https://github.com/alloy-rs/examples/tree/6ac6ececdbfb33142c128f21df07cd0e92a96620/examples/wallets/examples/verify_message.rs)。